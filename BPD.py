...
with open("Incidents_2020-10-01.csv") as f:
    print(f)
...
with open("Arrests_2020-10-01.csv") as f:
    print(f)
...
with open("BPDTrafficStops2012_2019.csv") as f:
    print(f)
...
with open("BPD_UseOfForce_2012_2018.csv") as f:
    print(f)
...
with open("HateCrimeOpenData.csv") as f:
    print(f)
